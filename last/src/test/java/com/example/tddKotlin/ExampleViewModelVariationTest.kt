...
// expectMostRecentItem()を使うと、脆いテストをもろくないテストに変えられます
// Using expectMostRecentItem() can help you transform fragile tests into robust tests.
@OptIn(ExperimentalCoroutinesApi::class)
@Suppress("RemoveRedundantBackticks", "NonAsciiCharacters")
class ExampleViewModelVariationTest {
